                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT tblstudents.StudentName,tblstudents.RollId,tblstudents.session,tblstudents.year,tblsubjects.SubjectName,tblsubjects.SubjectCode,tblresult.marks,tblresult.grade
FROM tblresult
JOIN tblsubjects ON (tblsubjects.id = tblresult.SubjectId)
JOIN tblstudents ON (tblstudents.StudentId = tblresult.StudentId)";$query = $dbh->prepare($sql);
$query->execute();
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            ...
                                                            <td><?php echo htmlentities($result->session);?>(<?php echo htmlentities($result->year);?>)</td>

...
for($i=0;$i<count($mark);$i++){
    $mar=$mark[$i];
  $sid=$sid1[$i]; */
$sql="INSERT INTO  tblresult(StudentId,SubjectId,marks,grade) VALUES(:studentid,:subjectid,:marks,:grade)";
...
<label for="default" class="col-sm-2 control-label">Student Reg. Number</label>
 <div class="col-sm-10">
 <select name="studentid" class="form-control clid" id="studentid"  required="required">
...
<label for="default" class="col-sm-2 control-label">Course</label>
 <div class="col-sm-10">
 <select name="subjectid" class="form-control clid" id="subjectid" required="required">
...
<div class="col-sm-10">
<input type="text" name="marks" class="form-control" id="marks" required="required" autocomplete="off">
</div>
</div>

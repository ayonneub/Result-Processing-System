...
$dob=$_POST['dob']; 
$status=1;
$sql="INSERT INTO  tblstudents(StudentName,RollId,session,year,StudentEmail,Gender,DOB,Status) VALUES(:studentname,:roolid,:session,:year,:studentemail,:gender,:dob,:status)";

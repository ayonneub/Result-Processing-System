...
$status=1;
$sql="INSERT INTO  assigned_course(course_id,user_id,Status) VALUES(:subject,:user,:status)";
...
<html lang="en">
    <head>
        ...
        <title>SMS Admin Assign Course< </title>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Assign Course</li>
                                        <li class="active">Add Course Assigned</li>
                                    </ul>
                                </div>
                                        ...
                                        <?php } ?>
                                                <form class="form-horizontal" method="post">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
 <select name="user" class="form-control" id="default" required="required">
...
{   ?>
<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->teacher_name); ?></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
